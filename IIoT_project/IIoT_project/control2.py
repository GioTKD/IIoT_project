...
def main():
    ...
    pub = node.create_publisher(geometry_msgs.msg.Twist, '/px4_2/offboard_velocity_cmd', qos_profile)

    arm_toggle = False
    arm_pub = node.create_publisher(std_msgs.msg.Bool, '/px4_2/arm_message', qos_profile)
